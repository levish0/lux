...
pub mod create_scopes;
pub mod scope;
pub mod visitor;

pub use create_scopes::{create_scopes, ScopeCreationResult};
pub use scope::{Binding, BindingId, BindingKind, DeclarationKind, Scope, ScopeId, ScopeTree};
