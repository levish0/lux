...
use super::props::validate_custom_element_props;
use super::shadow::parse_custom_element_shadow;
use super::tag::validate_custom_element_tag_name;

pub(super) fn parse_custom_element_expression<'a>(
    attr: &Attribute<'a>,
